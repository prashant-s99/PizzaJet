    ...
    <div className="space-y-8 px-4 py-6">
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="space-x-2">
          {priority && (
            <span className="rounded-full bg-red-500 px-3 pb-0.5 font-semibold tracking-wide text-red-50 uppercase">
              Priority{" "}
            </span>
          )}
          <span className="rounded-full bg-green-500 px-3 pb-0.5 font-semibold tracking-wide text-green-50 uppercase">
            {status} order
          </span>
        </div>
      </div>
